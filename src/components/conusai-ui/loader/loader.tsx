...
export function Loader({ visible, className }: LoaderProps) {
    ...
    <AnimatePresence>
      {visible ? (
        <motion.div
          ...
          exit="exit"
          className={cn(
            "absolute inset-0 z-50 flex items-center justify-center bg-[radial-gradient(circle_at_top,rgba(110,204,255,0.24),transparent_34%),linear-gradient(180deg,rgba(9,17,31,0.96),rgba(12,24,44,0.92))]",
            className
          )}
        >
